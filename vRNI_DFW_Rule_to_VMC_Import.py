...
class VMCRuleImport():
    ...
    def main(self):
        ...
        parser.add_argument('--appname', '-a', help='Name of application for imported rules')
        ...
        if not self.applicationname:
            self.applicationname = input('Please input name of application for imported rules:  ')
